...
export class Investors21720157330682 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX \`IDX_8b06321fab6cd8fb65dfd5337b\` ON \`investor_qu_master\``,
    );
    await queryRunner.query(
      `DROP INDEX \`IDX_a0b8156b5f202e08507f6c3ed5\` ON \`investor_qu_master\``,
    );
    await queryRunner.query(
      `DROP INDEX \`IDX_67a267127a4dab8620df210a3a\` ON \`investor_qu_master\``,
    );
    await queryRunner.query(
      `DROP INDEX \`IDX_10723fca38a08e35a49e98eff6\` ON \`investor_qu_master\``,
    );
    await queryRunner.query(
      `DROP INDEX \`IDX_c5f474500d86a4fba405c3d7c9\` ON \`investor_qu_master\``,
    );
    await queryRunner.query(
      `DROP INDEX \`IDX_dbfa15531fdeeb2619fb0d6b3a\` ON \`investor_qu_master\``,
    );
